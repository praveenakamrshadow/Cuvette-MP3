...
console.log("All Foods:", listAllFoods(foodData));
console.log("Vegetables:", listFoodsByCategory(foodData, "Vegetable"));
console.log("Fruits:", listFoodsByCategory(foodData, "Fruit"));
console.log("Proteins:", listFoodsByCategory(foodData, "Protein"));
console.log("Nuts:", listFoodsByCategory(foodData, "Nuts"));
console.log("Grains:", listFoodsByCategory(foodData, "Grain"));
console.log("Dairy:", listFoodsByCategory(foodData, "Dairy"));
console.log("Calories > 100:", listFoodsAboveCalories(foodData, 100));
console.log("Calories < 100:", listFoodsBelowCalories(foodData, 100));
console.log("High to Low Protein:", listFoodsByProteinContent(foodData));
console.log("Low to High Carbs:", listFoodsByCarbContent(foodData));
